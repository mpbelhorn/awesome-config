...
theme.icon_dir                      = os.getenv("HOME") .. "/.config/awesome/themes/current/icons"

theme.wallpaper                     = os.getenv("HOME") .. "/.config/wm_startup/desktop.jpg"

theme.topbar_path                   = "png:" .. theme.icon_dir .. "/topbar/"

theme.font                          = "Dejavu Sans Mono 10"
theme.taglist_font                  = "Dejavu Sans Mono 8"
theme.font_no_size                  = "Dejavu Sans Mono"
theme.fg_normal                     = "#FFFFFF"
theme.fg_focus                      = "#0099CC"
theme.highlight                     = "#80CCe6"
theme.dim                           = "#666666"
theme.alarm                         = "#cb4b16"
theme.bg_normal                     = "#242424"
theme.fg_urgent                     = "#b58900"
